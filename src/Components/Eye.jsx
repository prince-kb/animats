...
function Eye() {
  ...
  return (
    <div >
        <div data-scroll data-scroll-speed='0' className=" bg-red-800 z-[2] flex items-center justify-center h-screen w-full bg-center bg-cover bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg')] rounded-b-3xl">
